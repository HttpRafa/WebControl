<script lang="ts">
    ...
    import {application} from "../../../js/Store";
    import {WorkerStates} from "../../../js/enums/WorkerStates";
...
<div class="mr-9 ml-9 mt-9 mb-9 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
    <div class="px-4 py-5 sm:px-6">
        ...
        <div class="text-right mt-2">
            {#if $application.workerState === WorkerStates.starting}
            ...
            {/if}
            {#if $application.workerState === WorkerStates.restarting}
            ...
            {/if}
            {#if $application.workerState === WorkerStates.stopping}
